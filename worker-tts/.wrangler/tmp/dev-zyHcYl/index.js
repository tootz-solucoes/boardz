...
// .wrangler/tmp/bundle-pEeYYS/checked-fetch.js
...
// index.js
var ALLOWED_ORIGIN = "https://boardz.ttz.dev.br";
var TTS_TTL_SECONDS = 7 * 24 * 60 * 60;
var CORS_HEADERS = {
...
var index_default = {
  async fetch(request, env) {
    ...
    const voiceRssUrl = `https://api.voicerss.org/?key=${env.VOICERSS_API_KEY}&hl=pt-br&src=${encodeURIComponent(src)}&f=16khz_16bit_mono&r=-5&v=Ligia`;
...
// .wrangler/tmp/bundle-pEeYYS/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-pEeYYS/middleware-loader.entry.ts
